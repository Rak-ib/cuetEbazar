...
<body>
 ...
 <div class="container mx-auto " style="width: 600px; margin-top:100px;margin-bottom:100px;">
...
{
    ?>
    <h4 class="text-center " style="margin-bottom: 50px;">Send Another Response</h4>
    <?php
 ...
 ?>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" name="msg" id="" placeholder="write your comments.."></textarea>
      </div>
      <input type="submit" name="submit" style="text-align:center; mx-auto;" value="Send" class="btn btn-dark"><br>
    </form>
    ...
    if(isset($_POST['submit']))
    {
       ...
       $to = "u1904125@student.cuet.ac.bd";
       $subject = "Comments..";
       $msg = $_POST['msg'];
       $from = $_POST['email'];
       $headers = "From: $from";
       ...
       $sql1 = "INSERT INTO feedback (u_id,description) VALUES ('{$id}','{$msg}') " or die("unsuccessfull");
       $rs = mysqli_query($conn, $sql1);


    //    mail($to,$subject,$msg,$headers);
       ?>
       <h1 class="text-center " style="margin-bottom: 50px; font-weight:700;color:green;">Thank you For your Feedback</h1>
       <?php
