...
$sql1 = "SELECT *FROM products where pcategory = 'electronic'";
    ...
    <div class="container text-center text-md-left">
        <div class="row text-center text-md-left">
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                <h5 class="text-uppercase mb-4 font-weight-bold text-warning">eBay</h5>
                <p>Lorem ipsum dolor sit amet.footer content!!</p>
            </div>
            ...
            <div class="col-md-7 col-lg-8 ">
                <p>Copyright 02020 All rights reserved by:
                    <a href="" class="text-decoration-none">
                        <strong class="text-warning">eBay</strong>
                    </a>
                </p>
