...
$id_val = "s".$id;
$sql = "SELECT *FROM products WHERE s_id = '$id_val' AND pstatus = 'Sale'";
$res = mysqli_query($conn,$sql);

$temp_id = "b".$id;
$sqlm=" SELECT * FROM products WHERE b_id = '$temp_id'";
...
<section id="collection" class="py-5">
        <div class="container">
            <h3 style="text-align:center;font-weight:700;">Purchased Products</h3>
                ...
                <div class="col-md-3 best">
                    <div class="collection-list mt-xl-5" style="margin-top:20px";>
                        <div class="collection-img ">
                            ...
                            <!-- <div class="w-100"></div> -->
                            <span class=" position-absolute"><?php echo $rowm['pstatus'];?></span>
                        ...
                        <div class="text-center justify-content-center">
                            ...
                            <p class=""><?php echo $rowm['pname'];?></p>
                            <span class="" style="font-weight:600;"><?php echo "$".$rowm['price'];?></span>
                        </div>
