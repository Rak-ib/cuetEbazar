...
$sql = "SELECT *FROM products WHERE s_id = '$id_val'";
  ...
  <!--header-->
    <div class="header">
     ...
     <!--main content-->
          ...
          if(isset(  $_SESSION['failed_to_delete']))
          {
            echo $_SESSION['failed_to_delete'];
            unset(  $_SESSION['failed_to_delete']);
...
<section id="collection" class="py-5">
        <div class="container">
            <h3 style="text-align:center;font-weight:700;">My Posts</h3>
