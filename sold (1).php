...
$image_name = $row1['image']; //user image.. 

$id_val="s".$id;
$sql = "SELECT *FROM products WHERE s_id = '$id_val' AND pstatus = 'Sold'";
$res = mysqli_query($conn,$sql);

$sqlb="SELECT *FROM products where pstatus = 'Sold' AND s_id ='$id_val'";
$resb = mysqli_query($conn,$sqlb);
$rowb = mysqli_fetch_assoc($resb);
$countb = mysqli_num_rows($resb);


if($countb>0)
{
    $b_id = $rowb['b_id'];
    $sql1 = "SELECT *FROM user where id = '$b_id'";
    $res1 = mysqli_query($conn,$sql1);
...
<section id="collection" class="py-5">
        <div class="container">
            <h3 style="text-align:center;font-weight:700;">Sold</h3>
             ...
             ?> 
                ...
                <div class="col-md-3 best">
                    <div class="collection-list mt-xl-5" style="margin-top:20px";>
                        <?php
                        if($count1>0)echo '<h3>Sold to -> <a href=""><?php $buyer_name;?></a></h3>'
                        ?>
                        <div class="collection-img ">
                                        
                             <!-- <img src="images/<?php echo $image ?> "style="height:345px; width:306px;" class=""> -->
                             <a href="post_details.php?id=<?php echo $pid;?>">  <img src="images/<?php echo $image ?>"  style="height:345px; width:306px;" class=""></a>
                            <!-- <div class="w-100"></div> -->
                            <span class=" position-absolute"><?php echo $row['pstatus'];?></span>
                        ...
                        <div class="text-center justify-content-center">
                            ...
                            <p class=""><?php echo $row['pname'];?></p>
                            <span class="" style="font-weight:600;"><?php echo "$".$row['price'];?></span>
                        </div>

                        <div class="btn_box mb-5 mt-2 ml-5">                           
                            <a class="ml-3"href="update_post.php?pidd=<?php echo $pid;?>"><button class="btn btn-dark">Update</button></a>
                            <a href="delete_post.php?pidd=<?php echo $pid;?>"><button class="btn btn-dark">Delete</button></a>
                        </div>
