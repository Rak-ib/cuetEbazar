        ...
        <div class="boxx " style="background:white;">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" required value="<?php echo $id; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="pdesc" rows="3" ></textarea>
                </div>
                <div class="form-group">
                ...
                <input type="submit" name="submit" value="Submit" class="btn btn-dark"><br>
            </form>
        </div>
...
if(isset($_POST['submit']))
{
   ...
   //adding to database
   $sql = "INSERT INTO products(pname,pcategory,pdesc,pstatus,pimage,s_id,pdate,price) VALUES('{$pname}','{$pcate}','{$pdesc}','{$pstatus}','{$image_name}','{$s_id}','{$pdate}','{$price}')" or die("Query Unsuccessful");

   $res = mysqli_query($conn,$sql) or die("Query failed!!");
   if($res == TRUE)
   {
       $_SESSION['add-product']="<div style='color:green;'>Product Was Posted Successfully!!</div>";
                             ?>
                            <script>   
