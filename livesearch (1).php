        ...
        <div class="container">
            ...
            <?php
                   ...
                   { 
                     ...
                     $input = $key;
                     $query = "SELECT *FROM products WHERE (pname LIKE '{$input}%' OR pcategory LIKE '{$input}%') AND pstatus='Sale'";
             ...
             ?> 
                ...
                <?php
                    ...
                    ?>
                    <h3 style="text-align:center;font-weight:700; margin-top:200px;margin-bottom:200px;">No Products Found</h3>
                    <?php
